...
REPO_ROOT = Path(os.getenv("GALOIS_VERIFICATION_AGENT_DIR", os.getenv("GALOIS_VERIFICATION_WORKDIR", os.getcwd()))).resolve()
RUNTIME_ROOT = Path(os.getenv("GALOIS_VERIFICATION_RUNTIME_DIR", str(REPO_ROOT))).resolve()
MEMORY_ROOT = RUNTIME_ROOT / "memory"
RESULTS_ROOT = Path(os.getenv("GALOIS_VERIFICATION_RESULTS_DIR", str(RUNTIME_ROOT / "results"))).resolve()
