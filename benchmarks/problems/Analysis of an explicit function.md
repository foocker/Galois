...
### Problem 1: Analysis of an explicit function
...
1. Verify that $F_{\lambda,l}(R)$ is well-defined for $\lambda>0$ and $l\geq 2$ and $R>0$. Which means $C_{\lambda}(R)$ and $C_{l,\lambda}(R)$ not equal to zero for $R>0$. 
2. If $0<\lambda\leq 1$, $l\geq 2, l\in\mathbb{Z}$, then $F_{\lambda,l}(R)$ is negative and monotonic increasing for $R> 0$. 
3. If $\lambda>1$, $l\geq 2, l\in\mathbb{Z}$, there exists $R_1>0$, so that $F_{\lambda,l}(R)$ is increasing for $R\in (0,R_1)$, decreasing for $R>R_1$, and $F_{\lambda,l}(R_1)>0$.